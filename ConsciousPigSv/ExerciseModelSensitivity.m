...
for j=0:num_adj_pars
    ...
    Rest.Params.C11 = 0.4*Rest.Params.C11 + 0.6*C11;
    Rest.Params.C12 = 0.4*Rest.Params.C12 + 0.6*C12;
    Rest.Params.C13 = 0.4*Rest.Params.C13 + 0.6*C13;
...
adjust_pars = adjustables( find( [Sens1+Sens2'] >0.2) );
