...
figure;
subplot(1,2,1);
plot([1 2],[Control.A11(k), Act_Epi_E],'o-','MarkerEdgeColor','r',...
    'MarkerFaceColor','r','LineWidth',2,'Color','r'); hold on;
plot([1 2],[Control.A12(k), Act_Mid_E],'o-','MarkerEdgeColor','g',...
    'MarkerFaceColor','g','LineWidth',2,'Color','g');
plot([1 2],[Control.A13(k), Act_Endo_E],'o-','MarkerEdgeColor','b',...
...
subplot(1,2,2);
plot([1 2],[Control.D11(k)/100, Exercise.epi.D(k)/100],'o-','MarkerEdgeColor','r',...
    'MarkerFaceColor','r','LineWidth',2,'Color','r'); hold on;
plot([1 2],[Control.D12(k)/100, Exercise.mid.D(k)/100],'o-','MarkerEdgeColor','g',...
    'MarkerFaceColor','g','LineWidth',2,'Color','g');
plot([1 2],[Control.D13(k)/100, Exercise.endo.D(k)/100],'o-','MarkerEdgeColor','b',...
    'MarkerFaceColor','b','LineWidth',2,'Color','b');
set(gca,'xtick',[1,2],'xticklabel',{'Baseline','Exercise'},'Fontsize',12);
...
subplot(1,3,1);
plot([1 2],[Control.S_myo11(k), S_myo_Epi_E],'o-','MarkerEdgeColor','r',...
    'MarkerFaceColor','r','LineWidth',2,'Color','r'); hold on;
plot([1 2],[Control.S_myo12(k), S_myo_Mid_E],'o-','MarkerEdgeColor','g',...
    'MarkerFaceColor','g','LineWidth',2,'Color','g');
plot([1 2],[Control.S_myo13(k), S_myo_Endo_E],'o-','MarkerEdgeColor','b',...
    'MarkerFaceColor','b','LineWidth',2,'Color','b');
set(gca,'xtick',[1,2],'xticklabel',{'Baseline','Exercise'},'Fontsize',12);
xlim([0.5 2.5]);ylabel('Smyo','Fontsize',12);pbaspect([1 2 1]);

subplot(1,3,2);
plot([1 2],[Control.S_meta11(k), S_meta_Epi_E],'o-','MarkerEdgeColor','r',...
    'MarkerFaceColor','r','LineWidth',2,'Color','r'); hold on;
plot([1 2],[Control.S_meta12(k), S_meta_Mid_E],'o-','MarkerEdgeColor','g',...
    'MarkerFaceColor','g','LineWidth',2,'Color','g');
plot([1 2],[Control.S_meta13(k), S_meta_Endo_E],'o-','MarkerEdgeColor','b',...
    'MarkerFaceColor','b','LineWidth',2,'Color','b');
set(gca,'xtick',[1,2],'xticklabel',{'Baseline','Exercise'},'Fontsize',12);
xlim([0.5 2.5]);ylabel('S_{meta}','Fontsize',12);pbaspect([1 2 1]);

subplot(1,3,3);
plot([1 2],[Control.S_HR11(k), S_HR_Epi_E],'o-','MarkerEdgeColor','r',...
    'MarkerFaceColor','r','LineWidth',2,'Color','r'); hold on;
plot([1 2],[Control.S_HR12(k), S_HR_Mid_E],'o-','MarkerEdgeColor','g',...
    'MarkerFaceColor','g','LineWidth',2,'Color','g');
plot([1 2],[Control.S_HR13(k), S_HR_Endo_E],'o-','MarkerEdgeColor','b',...
    'MarkerFaceColor','b','LineWidth',2,'Color','b');
set(gca,'xtick',[1,2],'xticklabel',{'Baseline','Exercise'},'Fontsize',12);
