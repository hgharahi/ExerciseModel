...
Case.Params(k).C11 = 0.8*abs(C11)+0.2*Case.Params(k).C11;
Case.Params(k).C12 = 0.8*abs(C12)+0.2*Case.Params(k).C12;
Case.Params(k).C13 = 0.8*abs(C13)+0.2*Case.Params(k).C13;