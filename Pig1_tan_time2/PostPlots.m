...
legend('Control Model 1','Control Model 2','Anemia Model 1','Anemia Model 2','Dob+Anemia Model 1','Dob+Anemia Model 2','A = 0 (Passive)','A = 1 (Constricted)','Location','southeast','FontSize',14);
